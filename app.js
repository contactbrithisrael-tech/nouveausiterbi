...
(function () {
  ...
  function buildLivres() {
    ...
    cfg.liste.forEach(function (book) {
      ...
      var coverWrap = el('div', { class: 'book-card__cover' }, [
        el('img', { src: '', id: book.img_id, alt: book.titre, class: 'book-card__img' }),
  ...
  function buildContact() {
    ...
    block.appendChild(el('a', {
      ...
      text:   cfg.facebook.label
    }));
    block.appendChild(el('a', {
      href:  cfg.traites.url,
      class: 'btn btn--primary',
      text:  cfg.traites.label
    }));
  }
  ...
  /* ════════════════════════════════════════════════
     INIT — ordre : construire puis activer
  ════════════════════════════════════════════════ */
