...
var RBI_CONFIG = {
  ...
  rite: {
    ...
    intro: "Fondé par le T∴I∴F∴ Michaël DARMON, le Rite Brith Israël est un Rite Maçonnique Kabbalistique de 33 degrés puisant ses sources dans la Tradition Hébraïque, la Kabbale et la Franc-Maçonnerie universelle. Son nom honore la mémoire d'Israël DARMON, pilier spirituel et inspirateur du Rite.",
    cartes: [
      {
        icone: "✡",
