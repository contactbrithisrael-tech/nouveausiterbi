...
var RBI_CONFIG = {
  ...
  ────────────────────────────────────────────── */
  hero: {
    bandeau:   "A∴L∴G∴D∴G∴A∴D∴L∴U∴ — ב∴ס∴ד∴",
    titre_fr:  "Rite Brith Israël®",
    titre_he:  "ברית ישראל",
    subtitle:  "Rite Maçonnique Historique d'Inspiration Hébraïque & Kabbalistique en 33 degrés.",
    subtitle2: "Alliance de Lumière entre les Peuples, fidélité à la Tradition et à l'universalité de la Franc-Maçonnerie.",
  ...
  rite: {
    ...
    intro: "Fondé par le T∴I∴F∴ Mickaël DARMON-33°, le Rite Brith Israël est un Rite Maçonnique Kabbalistique de 33 degrés puisant ses sources dans la Tradition Hébraïque, la Kabbale et la Franc-Maçonnerie universelle. Son nom honore la mémoire d'Israël DARMON, pilier spirituel et inspirateur du Rite.",
    cartes: [
      {
        icone: "✡",
    ...
    liste: [
      {
        ...
        placeholder: "L",
        liens: [
          { label: "CoolLibri", url: "https://www.coolibri.com", style: "primary" }
        ]
      },
      {
        img_id:   "book-guide",
        titre:    "Guide de Survie pour Franc-Maçon Désemparé",
        sous:     "Michaël DARMON — Amazon KDP",
  ...
  tuilage: {
    ...
    succes: {
      ...
      message:  "M∴T∴C∴S∴,M∴T∴C∴F∴— Que la Lumière vous guide."
    },
    echec: {
      message: "Je ne saurais vous reconnaître malheuresement."
    },
